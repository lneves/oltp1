...
import org.caudexorigo.oltp1.model.CustomerTier;
...
/**
 * A Java port of the TPC-E EGen CCustomerSelection class.
 * <p>
 * This class encapsulates customer tier distribution functions and provides
 * functionality to:
 * <ul>
 * <li>Generate a customer's tier based on their customer ID</li>
 * <li>Generate a non-uniform random customer ID</li>
 * <li>Generate customer IDs within a specified partition</li>
 * </ul>
 * Based on inc/CustomerSelection.h and src/CustomerSelection.cpp.
 */
