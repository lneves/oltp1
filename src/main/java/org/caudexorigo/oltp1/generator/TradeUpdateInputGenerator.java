...
public class TradeUpdateInputGenerator
{
	...
	private static final int PERCENT_FRAME_1 = 33;
	private static final int PERCENT_FRAME_2 = 33;
	// The remaining 34% is for Frame 3

	private static final int MAX_ROWS_FRAME_1 = 20;
	private static final int MAX_UPDATES_FRAME_1 = 20;
	private static final int MAX_ROWS_FRAME_2 = 20;
	private static final int MAX_UPDATES_FRAME_2 = 20;
	private static final int MAX_ROWS_FRAME_3 = 20;
	private static final int MAX_UPDATES_FRAME_3 = 20;

	// Constants from MiscConsts.h for non-uniform random generation
	private static final int A_VALUE_FRAME_1 = 65535;
	private static final int S_VALUE_FRAME_1 = 7;
	...
	public TxTradeUpdateInput generateTradeUpdateInput()
	{
		...
		if (threshold <= PERCENT_FRAME_1)
		{
			...
			input.max_updates = MAX_UPDATES_FRAME_1;

			Set<Long> tradeIdSet = new HashSet<Long>();

			while (tradeIdSet.size() < MAX_ROWS_FRAME_1)
			{
				long t = GenUtils.nonUniformTradeId(random, maxOfInitialTradeId, A_VALUE_FRAME_1, S_VALUE_FRAME_1);
				tradeIdSet.add(t);
			}
		...
		else if (threshold <= PERCENT_FRAME_1 + PERCENT_FRAME_2)
		{
			...
			input.max_updates = MAX_UPDATES_FRAME_2;
		...
		else
		{
			...
			input.max_updates = MAX_UPDATES_FRAME_3;
