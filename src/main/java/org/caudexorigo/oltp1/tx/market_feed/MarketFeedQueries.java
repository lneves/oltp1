...
public interface MarketFeedQueries {
    ...
    /**
     * SQL to retrieve a list of pending trade requests triggered by new market prices.
     */
    ...
    /**
     * SQL to insert new records into the trade_history table for the triggered trades.
     */
