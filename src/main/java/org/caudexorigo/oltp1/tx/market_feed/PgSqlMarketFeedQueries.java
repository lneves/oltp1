...
public class PgSqlMarketFeedQueries implements MarketFeedQueries
{
	...
	public String updateTrade()
	{
		return """
				...
				WHERE
				    t_id IN (SELECT trade_id::bigint FROM regexp_split_to_table(:trade_lst, ',') AS trade_id);
				""";
	}
	...
	public String deleteTradeRequest()
	{
		return """
				...
				WHERE tr_t_id IN (SELECT trade_id::bigint FROM regexp_split_to_table(:trade_lst, ',') AS trade_id);
				""";
	}
	...
	public String insertTradeHistory()
	{
		return """
				...
				FROM regexp_split_to_table(:trade_lst, ',') AS trade_id;
				""";
	}
}
