...
/**
 * Provides the Microsoft SQL Server-specific SQL queries for the Trade-Lookup transaction.
 */
public class MsSqlTradeLookupQueries extends DefaultTradeLookupQueries
{
