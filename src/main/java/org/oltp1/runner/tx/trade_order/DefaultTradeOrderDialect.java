 ...
 */
public class DefaultTradeOrderDialect implements TradeOrderDialect
{
	@Override
	public String getCustomerInfo()
	{
		return """
				SELECT
					...
					, c_tax_id AS tax_id
					, CAST(c_tier AS int) AS cust_tier
	...
	public String getCustomerAssets()
	{
		return """
				SELECT
				    ca_bal + COALESCE(SUM(hs_qty * lt_price), 0.0) AS customer_assets
				FROM
				    customer_account
