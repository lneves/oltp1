...
ALTER TABLE broker ADD CONSTRAINT pk_broker PRIMARY KEY (b_id) WITH (FILLFACTOR = 75);
ALTER TABLE cash_transaction ADD CONSTRAINT pk_cash_transaction PRIMARY KEY (ct_t_id) WITH (FILLFACTOR = 95);
...
ALTER TABLE customer_account ADD CONSTRAINT pk_customer_account PRIMARY KEY (ca_id) WITH (FILLFACTOR = 82);
...
ALTER TABLE holding ADD CONSTRAINT pk_holding PRIMARY KEY (h_t_id) WITH (FILLFACTOR = 80);
ALTER TABLE holding_history ADD CONSTRAINT pk_holding_history PRIMARY KEY (hh_h_t_id, hh_t_id) WITH (FILLFACTOR = 95);
ALTER TABLE holding_summary ADD CONSTRAINT pk_holding_summary PRIMARY KEY (hs_ca_id, hs_s_symb) WITH (FILLFACTOR = 75);
ALTER TABLE industry ADD CONSTRAINT pk_industry PRIMARY KEY (in_id);
ALTER TABLE last_trade ADD CONSTRAINT pk_last_trade PRIMARY KEY (lt_s_symb) WITH (FILLFACTOR = 75);
...
ALTER TABLE settlement ADD CONSTRAINT pk_settlement PRIMARY KEY (se_t_id) WITH (FILLFACTOR = 92);
...
ALTER TABLE trade ADD CONSTRAINT pk_trade PRIMARY KEY (t_id) WITH (FILLFACTOR = 92);
ALTER TABLE trade_history ADD CONSTRAINT pk_trade_history PRIMARY KEY (th_t_id, th_st_id) WITH (FILLFACTOR = 95);
