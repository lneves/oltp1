...
public class SqlEngineTest
{
	...
	{
		assertEquals(SqlEngine.GENERIC, SqlEngine.detect("com.example.Driver", "jdbc:example://host:port/db"));
		assertEquals(SqlEngine.GENERIC, SqlEngine.detect(null, "jdbc:unknown-db://localhost"));
	}
